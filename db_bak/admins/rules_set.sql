-- FUNCTION: admins.rules_set(bigint, text, bigint, bigint, bigint, bigint, bigint, text)

-- DROP FUNCTION IF EXISTS admins.rules_set(bigint, text, bigint, bigint, bigint, bigint, bigint, text);

CREATE OR REPLACE FUNCTION admins.rules_set(
	p_game_id bigint,
	p_admin_token text,
	p_rtp bigint,
