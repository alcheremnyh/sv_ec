CREATE OR REPLACE FUNCTION admins.register_check() 
	RETURNS trigger
	LANGUAGE plpgsql AS
$register_check$
BEGIN
...
CREATE OR REPLACE TRIGGER register_check BEFORE INSERT ON admins.list
    FOR EACH ROW EXECUTE PROCEDURE admins.register_check();